...
object NetworkModule {
    ...
    private const val BASE_URL = "https://backend.belt.scanning.ripplehealthcare.in/"
    ...
    @Provides
    @Singleton
    fun provideBeltApiService(retrofit: Retrofit): BeltApiService {
        return retrofit.create(BeltApiService::class.java)
    }
}